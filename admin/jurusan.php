...
<main>
    <div class="container mt-3">
        <?php echo $_SERVER['REQUEST_URI'];?>
                ...
                <form class="row g-3 d-flex justify-content-end align-items-center mb-3 " action="create_jurusan.php" method="post">
                    <!-- <div class="col-md-6">
                        Jumlah Jurusan <input class="form-control" type="text" name="jumlah" size="1">
                    </div>
                    <div class="col-md-6">
                        <a type="submit" class="btn btn-primary mb-3" name="submit">Tambah Jurusan</a>
                    </div> -->
                    ...
                    <div class="col-2">
                        ...
                        <input class="form-control" type="text" name="jumlah" size="1">

                    </div>
                    <div class="col-2 text-end ">
                        <!-- <label for="inputZip" class="form-label">Zip</label>
                        <input type="text" class="form-control" id="inputZip"> -->
                        <a type="submit" class="btn btn-primary" name="submit">Tambah Jurusan</a>
